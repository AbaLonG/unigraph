...
public class ContextConfiguration {
    ...
    private static final String HIBERNATE_ENTITY_COPY_OBSERVER = "hibernate.event.merge.entity_copy_observer";
    ...
    private Properties jpaProperties() {
        ...
        properties.put(HIBERNATE_ENTITY_COPY_OBSERVER, "allow");
        return properties;
    }
