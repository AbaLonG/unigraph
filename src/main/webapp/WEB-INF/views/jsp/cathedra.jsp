              ...
              <div class="card border-0" style="background-color: ghostwhite">
                ...
                <div class="card-body p-0">
                  ...
                  <div class="w-100 text-center text-white pointer p-1"
                    ...
                    <a href="${pageContext.request.contextPath}/index?id=${cathedra.cathedraManager.login}"
                       class="text-decoration-none text-white">
                      ${cathedra.cathedraManager.fullName}
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-9 p-0 mt-3 mt-sm-0">
              ...
              <div class="card border-primary border-0"
                ...
                <div class="card-header pl-3 rounded-0 border-0 text-white"
                  ...
                  <h5 class="m-0">Cathedra: ${cathedra.title}</h5>
                </div>
              </div>
                ...
                <div class="col-12 col-sm-6 p-0">
                  <div class="card border-0">
                    <div class="card-header p-0 text-white border-0 rounded-0"
                      ...
                      <p class="m-0 my-2 pl-3">Groups:</p>
                    </div>
                    <div class="card-body p-0">
                      <table class="table table-striped table-hover m-0">
                        <tbody>
                        <c:forEach var="group" items="${cathedra.groups}">
                          <tr>
                            <td>
                              <a href="${pageContext.request.contextPath}/group?groupTitle=${group.title}"
                ...
                <div class="col-12 col-sm-6 p-0">
                  <div class="card border-0">
                    ...
                    <div class="card-body p-0 border-0 rounded-0">
                      <table class="table table-striped table-hover m-0">
                        <tbody>
                        <c:forEach var="teacher" items="${controller.teachersOfCathedra}">
                          <tr>
                            <td>
